    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            getThemeColor(weatherModel.weatherCondithion),
            getThemeColor(weatherModel.weatherCondithion)[300]!,
            getThemeColor(weatherModel.weatherCondithion)[50]!,
          ],
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              weatherModel.weatherCondithion!,
              style: TextStyle(
                fontWeight: FontWeight.bold,
                fontSize: 32,
              ),
